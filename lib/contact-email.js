...
<tr>
<td style="padding:28px 32px 20px;border-bottom:1px solid ${BRAND.border};background:linear-gradient(180deg,#1a1a1a 0%,${BRAND.card} 100%);">
<table role="presentation" width="100%" cellspacing="0" cellpadding="0">
<tr>
<td valign="middle" style="padding-right:16px;">
<img src="${logoSrc}" alt="CETENIS" width="180" height="auto" style="display:block;max-height:48px;width:auto;height:auto;border:0;outline:none;">
</td>
<td valign="middle" align="right" style="font-size:11px;letter-spacing:0.14em;text-transform:uppercase;color:${BRAND.muted};">
Empowering Data
</td>
</tr>
</table>
